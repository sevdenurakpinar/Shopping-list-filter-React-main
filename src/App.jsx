...
const shops = [
  ...
  { id: 3, name: 'BİM'},
  { id: 4, name: 'Carrefour'  },
  // Ekstra mağazalar ekleyebilirsiniz
];

const categories = [
  { id: 1, name: 'Elektronik', description: 'Elektronik ürünler' },
  { id: 2, name: 'Gıda', description: 'Temel gıda ürünleri' },
  { id: 3, name: 'Şarküteri', description: 'Çeşitli şarküteri ürünleri'},
  { id: 4, name: 'Oyuncak', description: 'Çocuk oyuncakları'},
  { id: 5, name: 'Ev & Yaşam', description: 'Ev eşyaları'},
  // Ekstra kategoriler ekleyebilirsiniz
];
...
const ShoppingList = () => {
  ...
  useEffect(() => {
    ...
    if(products.length > 0 && isAllBought){
      alert("Tebrikler! Alışverişiniz Tamamlandı.")
    }
  }, [products]);
